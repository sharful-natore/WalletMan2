...
# Sort from bottom (largest Y start) to top (smallest Y start)
sorted_parts = sorted(abs_parts, key=lambda x: x[0], reverse=True)

print("Kotlin Array Definition:")
print("private val ridgePathData = arrayOf(")
for y, p in sorted_parts:
    print(f'    "{p}", // Start Y: {y}')
print(")")
